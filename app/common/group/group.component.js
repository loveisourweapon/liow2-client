...
const GroupComponent = {
  ...
  template: `
    <jumbotron jumbo-image="'/images/group.png'"
      ...
      <jumbo-title>{{ $ctrl.group.name }}</jumbo-title>
      <jumbo-text>
        <span class="f-lg">
          {{ $ctrl.Act.counters[$ctrl.group._id] | number }}
        </span>
        acts of love
      </jumbo-text>
    </jumbotron>
      ...
      <div class="row">
        <div class="col-sm-4 col-md-3 col-sm-push-8 col-md-push-9 m-b-lg">
          <div class="well well-sm"
               ng-if="$ctrl.User.isMemberOfGroup($ctrl.group) && $ctrl.campaign !== null">
            ...
            <div ng-if="$ctrl.Group.isAdmin($ctrl.group, $ctrl.User.current)">
              <hr>
              <button type="button"
                      class="btn btn-default btn-block"
                      ng-click="$ctrl.editCampaign('update', $ctrl.group, $ctrl.campaign)">
          ...
          <button type="button"
                  class="btn btn-default btn-block"
                  ng-click="$ctrl.editCampaign('create', $ctrl.group)"
          ...
          <button type="button"
                  class="btn btn-default btn-block"
                  ng-click="$ctrl.Modal.openGroupEdit('update', $ctrl.group)"
                  ng-if="$ctrl.Group.isAdmin($ctrl.group, $ctrl.User.current)">
            <i class="fa fa-fw fa-edit"></i>
            Update group
          </button>
        ...
        <div class="col-sm-8 col-md-9 col-sm-pull-4 col-md-pull-3">
          ...
          <uib-tabset active="$ctrl.activeTab"
            ...
            <uib-tab>
              ...
              <blockquote marked="$ctrl.group.welcomeMessage"
                          ng-if="$ctrl.group.welcomeMessage"></blockquote>
  
              <div ng-if="!$ctrl.group.welcomeMessage">
                <h2>
            ...
            <uib-tab>
              ...
              <feed criteria="{ group: $ctrl.group._id }"
              ...
              <p ng-if="!$ctrl.User.isAuthenticated()">
                ...
                to see {{ $ctrl.group.name }}'s Activity Feed.
              </p>
            </uib-tab>
          </uib-tabset>
        </div>
